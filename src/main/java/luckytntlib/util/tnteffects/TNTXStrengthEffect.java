...
public class TNTXStrengthEffect extends PrimedTNTEffect{
	...
	public void serverExplosion(IExplosiveEntity entity) {
		ImprovedExplosion explosion = new ImprovedExplosion(entity.getLevel(), (Entity) entity, entity.getPos().x, entity.getPos().y, entity.getPos().z, strength);
	...
	// Đây là phương thức mở rộng của ImprovedExplosion để thêm hàm xử lý nổ cả netherite_block
