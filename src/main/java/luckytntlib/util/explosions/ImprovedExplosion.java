...
public class ImprovedExplosion extends Explosion{
	...
	public void doBlockExplosionWithNetherite(float xzStrength, float yStrength, float resistanceImpact, float randomVecLength, boolean fire, boolean isStrongExplosion) {
